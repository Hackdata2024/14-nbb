...
import 'package:binalert/screens/edit_profile_page.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    //     'data': authRepository.userModel.userStat.daysActive,
    //   },
    //   {
    ...
    //       Icons.score,
    //     ),
    //     'data': authRepository.userModel.userStat.totalScore,
    //   },
    //   {
    //     'title': 'Bob Johnson',
    ...
    //   // Add more profile data as needed and add scroll if needed
    // ];
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                authRepository.userModel.userStat.dailyStreak
                                    .toString(),
                                style: TextStyle(
                                    fontSize: 24,
                          ...
                          children: [
                            Text('Days Active',
                                style: TextStyle(
                                    fontSize: 20, fontWeight: FontWeight.bold)),
                            Text(
                                authRepository.userModel.userStat.daysActive
                                    .toString(),
                                style: TextStyle(
                                    color: Color.fromARGB(255, 78, 78, 78),
                                    fontSize: 80,
